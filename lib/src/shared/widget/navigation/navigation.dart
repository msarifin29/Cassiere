...
class _ExNavigationState extends State<ExNavigation> {
  ...
  getNavigation() {
    var selectedColor = widget.selectedColor ?? AppColor.grey800;
    var unselectedColor =
        widget.unselectedColor ?? AppColor.grey800.withOpacity(0.4);
                              ...
                              child: Column(
                                ...
                                children: [
                                  Icon(
                                    ...
                                    color: selectedIndex == index
                                        ? AppColor.grey700
                                        : AppColor.grey800.withOpacity(0.4),
                                    size: selectedIndex == index ? 20.0 : 16.0,
                                  ),
                                  const SizedBox(
                                    height: 4.0,
    ...
    return BottomNavigationBar(
      ...
      selectedItemColor: widget.selectedColor ?? AppColor.grey800,
